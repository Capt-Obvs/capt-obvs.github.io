...
<html lang="en" style="height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>  Crypto Minning   || User Dashboard || Investment </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="https://cryptominning.ltd/customer/investment.php#">Dashboard</a></li>
  ...
  "locale": "en"
                ...
                <div class="card">
                    <div class="panel panel-primary">
                        <div class="panel-header">
                            <h4 class="text-center">Basic Plan</h4>
                        </div>
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> 10% After  0 day 10 hours  </li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Min: $50</li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Max: $500</li>
						...
						<?php
						echo "
                        <a href='https://cryptominning.ltd/customer/enterplan.php?plan=basic&id=".$_SESSION['user_id']."' class='btn btn-primary btn-block btn-flat'> 
             ...
             <div class="col-lg-6">
                <div class="card">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> 15% After  0 day 10 hours  </li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Min: $600</li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Max: $2,500</li>
                        ...
                        <?php
						echo "
                        <a href='https://cryptominning.ltd/customer/enterplan.php?plan=standard&id=".$_SESSION['user_id']."' class='btn btn-primary btn-block btn-flat'> 
                            <span class='ti ti-new-window'></span> Join and invest
                        </a>";
						?>
                        </div>
             ...
             <div class="col-lg-6">
                <div class="card">
                    <div class="panel panel-primary">
                        <div class="panel-header">
                            <h4 class="text-center">Diamond Plan</h4>
                        </div>
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> 35% After  0 day 8 hours  </li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Min: $1,800</li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Max: $10,000</li>
                        ...
                        <?php
						echo "
                        <a href='https://cryptominning.ltd/customer/enterplan.php?plan=diamond&id=".$_SESSION['user_id']."' class='btn btn-primary btn-block btn-flat'> 
                            <span class='ti ti-new-window'></span> Join and invest
                        </a>";
						?>
                        </div>
             ...
             <div class="col-lg-6">
                <div class="card">
                    <div class="panel panel-primary">
                        <div class="panel-header">
                            <h4 class="text-center">Silver Plan</h4>
                        </div>
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> 50% After  0 day 8 hours  </li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Min: $2,700</li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Max: $30,000</li>
                        ...
                        <?php
						echo "
                        <a href='https://cryptominning.ltd/customer/enterplan.php?plan=silver&id=".$_SESSION['user_id']."' class='btn btn-primary btn-block btn-flat'> 
                            <span class='ti ti-new-window'></span> Join and invest
                        </a>";
						?>
                        </div>
             ...
             <div class="col-lg-6">
                <div class="card">
                    <div class="panel panel-primary">
                        <div class="panel-header">
                            <h4 class="text-center">Gold Plan</h4>
                        </div>
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> 70% After  0 day 4 hours  </li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Min: $5,000</li>
                                <li class="list-group-item text-center"> <span class="ti ti-check"></span> Max: $100,000</li>
                        ...
                        <?php
						echo "
                        <a href='https://cryptominning.ltd/customer/enterplan.php?plan=gold&id=".$_SESSION['user_id']."' class='btn btn-primary btn-block btn-flat'> 
                            <span class='ti ti-new-window'></span> Join and invest
                        </a>";
						?>
                        </div>
