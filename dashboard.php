                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="https://cryptominning.ltd/customer/#">Dashboard</a></li>
                                ...
                                <div class='stat-widget-eight'>
                                    <div class='stat-header'>
                                        ...
                                        <div class='pull-right'>
                                               <div class='stat-icon'>
                                                 <i class='ti-wallet bg-primary' style='font-size: 60px; border-radius: 100%; background: #D69C63;'></i>
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='stat-content'>
                                        <div class='pull-left'>
                                            <span class='stat-digit'> $ ".$row['current_balance']."</span>
                                        </div> 
                                    </div>
                                    <div class='clearfix'></div>
                                </div>
                            ...
                            <div class='card'>
                                <div class='stat-widget-eight'>
                                    <div class='stat-header'>
                                        ...
                                        <div class='pull-right'>
                                               <div class='stat-icon'>
                                                 <i class='ti-server bg-primary' style='font-size: 60px; border-radius: 100%; background: #D69C63;'></i>
                                                </div>
                                        </div>
                                    </div>
                                    <div class='clearfix'></div>
                                    <div class='stat-content'>
                                        <div class='pull-left'>
                                            <span class='stat-digit'> $ ".$row['total_deposit']."</span>
                                        </div> 
                                    </div>
                                    <div class='clearfix'></div>
                                </div>
                            ...
                            <div class='card'>
                                <div class='stat-widget-eight'>
                                    <div class='stat-header'>
                                        ...
                                        <div class='pull-right'>
                                               <div class='stat-icon'>
                                                 <i class='ti-money bg-primary' style='font-size: 60px; border-radius: 100%; background: #D69C63;'></i>
                                                </div>
                                        </div>
                                    </div>
                                    <div class='clearfix'></div>
                                    <div class='stat-content'>
                                        <div class='pull-left'>
                                            <span class='stat-digit'> $ ".$row['total_withdrawals']."</span>
                                        </div> 
                                    </div>
                                    <div class='clearfix'></div>
                                </div>
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12"></div>
                            ...
                            <div class="bootstrap-data-table-panel">
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 table-responsive">
                                    <div id="example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-12">
									<table id="example" class="display table table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="example_info">
                                        <thead>
                                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="S/N: activate to sort column descending" style="width: 42px;">S/N</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Registration Date: activate to sort column ascending" style="width: 171px;">Registration Date</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="User Name: activate to sort column ascending" style="width: 112px;">User Name</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Username: activate to sort column ascending" style="width: 105px;">Username</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="User email: activate to sort column ascending" style="width: 108px;">User email</th><th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="User Phone: activate to sort column ascending" style="width: 117px;">User Phone</th></tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div class="card-body">
									...
									$accounts_id = "SELECT username FROM users WHERE id = '".$_SESSION['user_id']."' ";
											...
											if ($accountsid->num_rows > 0) {
												while ($row = $accountsid->fetch_assoc()){
									echo "
                                        <strong class='text-right'> http://cryptominning.ltd/signup.php?".$row['username']."</strong>
										";
										}
										}
										?>
